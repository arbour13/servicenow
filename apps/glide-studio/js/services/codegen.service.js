/* GlideRecord/naming codegen. Deliberately pure: every function takes plain data in and returns
   a string/value out - nothing here reaches into $scope or any global state, so this logic is
   independently testable and reusable from any controller/service. */
angular.module('glideStudio').factory('CodegenService', function () {
  'use strict';
