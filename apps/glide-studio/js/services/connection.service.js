/* Connected-mode API access, via Angular's $http. Two branches: instance-hosted (deployed as a
   widget, same-origin, session cookie + X-UserToken) vs standalone (cross-origin to a
   manually-entered instance, Basic Auth). */
angular.module('glideStudio').factory('ConnectionService', ['$http', '$q', function ($http, $q) {
  'use strict';
