/* Offline default schema (table -> field list) for the common ServiceNow tables, used when not
   connected to a live instance. See SchemaLiveService for the connected-mode Table API pulls. */
angular.module('glideStudio').factory('SchemaService', function () {
  'use strict';
