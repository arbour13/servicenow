/* GlideAggregate codegen. Pure functions, same discipline as CodegenService - reuses it via DI
   instead of duplicating camel/cap/wrapInFn/etc. */
angular.module('glideStudio').factory('AggregateService', ['CodegenService', 'SchemaService', function (CodegenService, SchemaService) {
  'use strict';
