/* <div class="modal-overlay" ng-if="vm.confirm.open" gs-modal="vm.closeConfirm()" gs-modal-focus="confirmCancelBtn">
   ...
   Shared chrome for every modal-overlay: Escape closes it (via the gs-modal expression), Tab is
   trapped inside it, focus moves to gs-modal-focus's element once it renders (falling back to the
...
angular.module('glideStudio').directive('gsModal', ['$timeout', function ($timeout) {
  return {
    restrict: 'A',
