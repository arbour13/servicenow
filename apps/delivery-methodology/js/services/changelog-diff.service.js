/* Pure sub-phase change descriptions for the auto-changelog on Save.
   No Angular state - callers pass before/after snapshots and a jobTitleById lookup. */
angular.module('deliveryMethodology').factory('ChangelogDiffService', [function () {
  'use strict';
