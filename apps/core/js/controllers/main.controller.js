/* Core's own widget controller. Core's widget is a live doc viewer: it renders Core's self-
   ...
   the shared viewer and a useful reference for the apps that depend on Core. The SN Deployment
   Packager reads this controller as the widget's client_script (see scripts/build-deploy.js). */
